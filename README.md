...
BookmarkChess was the first HTML-valid, non-Flash, fully functional, real-time, non-native mobile-ready chessboard. It inspired the HTML5 boards now used by Lichess.org and others. See [BookmarkChess](https://youtu.be/wQLXnEwzpYo?t=151) on YouTube.
